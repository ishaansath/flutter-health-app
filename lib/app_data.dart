...
final Map<String, Map<String, dynamic>> organData = {
  "Brain": {
    ...
    "fruits": [
      {
        "name": "Banana",
        "normalModeDescription": "Bananas are a top-tier brain food because they support mood regulation, memory, and steady focus. They're particularly helpful during exams or mentally demanding days.\n\n Rich in vitamin B6, bananas aid in the production of neurotransmitters like serotonin and dopamine. They also contain potassium and natural sugars for stable energy.\n\n Eat bananas in the morning or before a study session. Pair with nut butter for extra brain fuel. Always choose ripe bananas for optimal nutrition.\n\nBananas release energy slowly and steadily into the bloodstream, helping the brain stay alert and active over longer periods without energy crashes.\n\nVitamin B6 in bananas supports neurotransmitter synthesis, especially dopamine, which enhances focus, motivation, and memory retention.\n\n The brain’s electrical conductivity is supported by potassium, and B6 acts as a coenzyme in neurotransmitter metabolism, directly influencing brain chemistry.",
        "funModeDescription": "Bananas are mood boosters that power up your brain with steady energy and sharp focus. With vitamin B6 and natural sugars, they keep you clear-headed and ready to ace anything. No more brain fog, just smooth cognitive vibes!",
