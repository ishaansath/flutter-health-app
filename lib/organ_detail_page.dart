        ...
        'shortDescription': 'Wait! Why am I dizzy?'
          ...
          'diseases': {
            ...
            'items': [
              ...
              {
                'title': 'Stroke',
                'description': 'Occurs when blood flow to a part of the brain is interrupted, causing brain cells to die.'
              },
            ],
          },
          'food': {
              ...
              if (moreInfoCategories != null && moreInfoCategories.isNotEmpty)
                CustomButton(
                  ...
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      // --- THIS IS THE CORRECTED NAVIGATION TO MOREINFOPAGE ---
                      builder: (_) => MoreInfoPage(
                        organ: organName, // Pass the organ name
                        mode: mode,       // Pass the current mode
                        moreInfoData: moreInfoCategories, // Pass the map of more info categories
                      ),
                    ),
                  ),
                ),
